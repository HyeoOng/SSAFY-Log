...
- **메인 페이지**
  ...
  - JSON 데이터를 이용해 동적으로 비디오 정보를 로드
    <img src="./readme/윤셔PJT.png" width="60%"/>
...
- **운동 영상 리뷰 관리 페이지**
  ...
  - **리뷰 삭제**: 선택된 리뷰를 삭제
    <img src="./readme/reviewPage.png" width="60%"/>
    <img src="./readme/reviewPage2.png" width="60%"/>
...
- **회원 관리**
  ...
  - **로그인 페이지**: 사용자 로그인 폼 제공
    <img src="./readme/signupPage.png" width="60%"/>
    <img src="./readme/loginPage.png" width="60%"/>
